 ...
 */
final class Version20230314163211 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `table` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, nb_covers INT NOT NULL, reservation_date DATETIME NOT NULL, INDEX IDX_F6298F46A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
